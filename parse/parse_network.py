...
class Network():
    ...
    def num_kegg_gene_interaction(self):
        ...
        kegg_gene_annotation_df.to_csv('../data/filtered_data/kegg_gene_num_dict.csv', index=False, header=True)
        ...
        kegg_gene_interaction_df.to_csv('../data/filtered_data/kegg_gene_num_interaction.csv', index=False, header=True)
        ...
        kegg_gene_interaction_sym_df.to_csv('../data/filtered_data/kegg_gene_num_interaction_sym.csv', index=False, header=True)

    def num_drugbank_interaction(self):
        ...
        drugbank_drug_annotation_df.to_csv('../data/filtered_data/drug_num_dict.csv', index=False, header=True)
        ...
        final_drugbank_num_df.to_csv('../data/filtered_data/final_drugbank_num.csv', index=False, header=True)
        ...
        final_drugbank_num_sym_df.to_csv('../data/filtered_data/final_drugbank_num_sym.csv', index=False, header=True)
    
    def combine_network(self):
        kegg_gene_num_interaction_df = pd.read_csv('../data/filtered_data/kegg_gene_num_interaction.csv')
        kegg_gene_num_interaction_df = kegg_gene_num_interaction_df.rename({'src': 'from', 'dest': 'to'}, axis='columns')
        final_drugbank_num_df = pd.read_csv('../data/filtered_data/final_drugbank_num.csv')
        ...
        all_edge_num_df.to_csv('../data/filtered_data/all_edge_num.csv', index=False, header=True)


Network().num_kegg_gene_interaction()
Network().num_drugbank_interaction()
